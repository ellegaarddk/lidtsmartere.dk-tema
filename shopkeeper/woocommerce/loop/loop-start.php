...
<div class="row">
	<div class="large-12 columns">
		<ul id="products-grid" class="products products-grid small-block-grid-2 medium-block-grid-<?php echo $products_per_column_large; ?> large-block-grid-<?php echo $products_per_column_large; ?> xlarge-block-grid-<?php echo $products_per_column_xlarge; ?> xxlarge-block-grid-<?php echo $products_per_column; ?> columns-<?php echo $products_per_column; ?>">