				...
				<table class="totals">
					<tfoot>
						...
						<tr class="<?php echo $key; ?>">
							...
							<?php $useTotle = explode(" ", $total['value']);?>
							<td class="price"><span class="totals-price"><?php echo $useTotle[0] . " " . $useTotle[1]; ?></span></td>
						</tr>
						<?php endforeach; ?>
					</tfoot>
				</table>
...
<div id="footer">
	<p>Du har nu modtaget din ordre fra <a href="lidtsmartere.dk" target="_blank">Lidtsmartere.dk</a><br><br>
	<a href="lidtsmartere.dk" target="_blank">Lidtsmartere.dk</a> og Blå Kors Genbrug er stolte af at kunne præsentere vores nye og forbedrede Webshop. Vi ønsker at gøre det endnu sjovere at shoppe genbrugsfund på nettet. <a href="lidtsmartere.dk" target="_blank">Lidtsmartere.dk</a> er en webshop udelukkende drevet af frivillige. Vi gør et stort stykke arbejde ud af at udvælge de helt rigtige varer til dig. Vi er med hele vejen fra klargøring til fotografering og præsentation af varen. Vi ønsker på bedste måde at servicere alle vores fantastiske kunder. Vigtigst af alt: Vi har det altid sjovt, og det skal derfor også være sjovt for vores kunder.
	<br> <br>
	Tak fordi netop du valgte at støtte lidtsmartere.dk og Blå Kors Genbrug.</p>
</div>
